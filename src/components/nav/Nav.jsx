      ...
      <nav className="nav">
        <div className="nav__menu">
          <ul className="nav__list">
            ...
            <li className="nav__item">
              <a href="#about" className="nav__link"><FaUserAstronaut /></a>
            </li>

            <li className="nav__item">
              <a href="#education" className="nav__link"><FaBookReader /></a>
            </li>

            <li className="nav__item">
              <a href="#portfolio" className="nav__link"><FaCodeBranch /></a>
            </li>

            <li className="nav__item">
              <a href="#contact" className="nav__link"><FaRocketchat /></a>
            </li>
          </ul>
        </div>
      </nav>
